...
import static org.firstinspires.ftc.teamcode.RedSidePinpoint.RedSidePinpointConfigurables.*;
...
public class RedSidePinpoint extends OpMode {
    ...
    // Start pose of the robot (in inches)
    private final double startX = 118.5;
    private final double startY = 126.585;
    private final double startHeading = 0; // degrees
        ...
        switch (pathState) {
            ...
            case 1:
                ...
                if (isNavigationComplete()) {
                    ...
                    intakePassiveIndex();
                    driveToPose(intakePathEndXCoordinate, 85.0, 0.0);
                    setPathState(2);
                }
                break;
            case 2:
            ...
            case 3:
                ...
                if (isNavigationComplete()) {
                    magDump(1.0);
                    driveToPose(shootPositionXCoordinate, 60.0, 0.0);
                    setPathState(4);
                }
                break;
            case 4:
                ...
                if (isNavigationComplete()) {
                    intakePassiveIndex();
                    setMaxPower(intakePathMaxDrivetrainPower);
                    driveToPose(intakePathEndXCoordinate, 60.0, 0.0);
                    setPathState(5);
                }
                break;
            case 5:
            ...
            case 6:
                ...
                if (isNavigationComplete()) {
                    magDump(1.0);
                    driveToPose(shootPositionXCoordinate, 35.0, 0.0);
                    setPathState(7);
                }
                break;
            case 7:
                ...
                if (isNavigationComplete()) {
                    intakePassiveIndex();
                    setMaxPower(intakePathMaxDrivetrainPower);
                    driveToPose(intakePathEndXCoordinate, 35.0, 0.0);
                    setPathState(8);
                }
                break;
            case 8:
